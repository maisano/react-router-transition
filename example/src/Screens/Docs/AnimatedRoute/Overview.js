...
const Overview = () => (
  <div>
    ...
    <h2>Interruptible</h2>
    <p>Transitions on an <Element name="AnimatedRoute" /> are <em>interruptible</em>. This means that if an animation is currently in motion and its match is toggled, it will redirect itself to its proper state mid-transition.</p>
    <h2>Nestable</h2>
